...
//        permutation_sum_max(myList, visited , 3, temp_sum,0);
//        System.out.println(answer);
        ...
        tired(k , dungeons, visited, temp_sum, count);
        System.out.println(answer);
    }

    static void tired(int k, int[][] dungeons, boolean[] visited, int temp_sum, int count){
        if(count > answer){
            answer = count;
        }
        ...
        for(int i= 0; i<dungeons.length;i++){
            if(visited[i] == false && k>=dungeons[i][0]+temp_sum) {
                visited[i] = true;
                temp_sum +=  dungeons[i][1];
                tired(k, dungeons, visited, temp_sum, count+1);
                temp_sum -=  dungeons[i][1];
                visited[i] = false;
            }
        }
...
//
//
//    static void permutation_sum_max(List<Integer> list, boolean[] visited, int n, int temp_sum, int count){
//        if(count == n){
//            if(answer < temp_sum){
//                answer = temp_sum;
//            }
...
//                visited[i] = true;
//                temp_sum += list.get(i);
//                permutation_sum_max(list,visited, n, temp_sum ,count+1);
//                temp_sum -= list.get(i);
//                visited[i] = false;
//            }
//        }
